...
const Navbar = () => {
  ...
  return (
    <div className='navbar-bg bg-gray-700 text-violet-50 h-28 sm:h-20 flex justify-center items-center p-10 sm:p-0'>
      <div className='navbar container mx-auto flex items-center justify-between flex-col gap-3 sm:gap-0 sm:flex-row'>
        <div className='left'>
          <Link to='/' className='group'>
            <span className='logo text-xl font-semibold group-hover:text-indigo-500 duration-200'>
              Gig
              <span className='group-hover:text-indigo-500 group-hover:text-violet-50 duration-200'>
                Tech
              </span>
            </span>
          </Link>
        ...
        <div className='right flex items-center gap-5'>
          ...
          <NavLink to='/login' className='nav-link' style={isNavActiveStyles}>
            Sign In
          </NavLink>
          <NavLink to='/register' className='nav-link' style={isNavActiveStyles}>
            Sign Up
          </NavLink>
          <Link to='/cart'>
